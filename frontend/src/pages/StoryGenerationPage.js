...
const commonModels = [
  // NebulaCoder-V8.0 removed due to severe performance issues (extremely slow, >15 minutes per task)
...
const StoryGenerationPage = () => {
  ...
  const [model, setModel] = useState('nebulacoder-v8.0'); // Default to NebulaCoder-V8.0
