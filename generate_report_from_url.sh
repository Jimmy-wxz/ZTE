#!/bin/bash
# 从指定URL生成报告的脚本
# 用法: ./generate_report_from_url.sh "https://example.com/article" "报告主题"
...
python3 web_extractor.py "$URL" --output /tmp/webpage_content.txt
...
OUTPUT_FILE="../web_report_output.jsonl"
DONE_FILE="../web_report_done.txt"
